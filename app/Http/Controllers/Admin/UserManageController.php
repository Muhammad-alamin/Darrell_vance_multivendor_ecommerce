...
class UserManageController extends Controller
{
    ...
    public function userList(){
        $data ['userList'] = User::where('role_as','!=', 'admin')->orderBy('id','DESC')->paginate(10);
    ...
    public function customerList(){
        $data ['customerList'] = User::where('role_as','=', 'customer')->orderBy('id','DESC')->paginate(10);
        return view('admin.userManagement.customerList' ,$data);
    }

    public function editCustomer($id){
        $decrypt_id = decrypt($id);
        $data ['customer'] = User::where('role_as','=', 'customer')->orderBy('id','DESC')->find($decrypt_id);
    ...
    public function sellerList(){
        $data ['sellerList'] = User::where('role_as','=', 'vendor')->orderBy('id','DESC')->paginate(10);
        return view('admin.userManagement.sellerList' ,$data);
    }

    public function editSeller($id){
        $decrypt_id = decrypt($id);
        $data ['seller'] = User::where('role_as','=', 'vendor')->orderBy('id','DESC')->find($decrypt_id);
