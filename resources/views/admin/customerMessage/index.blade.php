                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">Message List</h4>
                                </div>
                            </div>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="{{route('admin.sendMessage.customer',encrypt($customerMessage->id))}}"><em class="icon ni ni-eye"></em><span>Send message</span></a></li>
                                                                        <li><a href="{{route('admin.customerMessage.details',encrypt($customerMessage->id))}}"><em class="icon ni ni-eye"></em><span>Details</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
