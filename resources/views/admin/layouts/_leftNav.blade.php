    ...
    <div class="nk-sidebar-main is-light">
        <div class="nk-sidebar-inner" data-simplebar>
            <div class="nk-menu-content menu-active" data-content="navDashboards">
                <img class="text-center" src="{{asset('assets/admin_logo.png')}}" style="width: 180px">
                <br>
                <br>
                <ul class="nk-menu">
                    <li class="nk-menu-item">
                        <a href="{{route('admin.dashboard')}}" class="nk-menu-link @if(request()->routeIs('admin.dashboard'))  active @endif">
