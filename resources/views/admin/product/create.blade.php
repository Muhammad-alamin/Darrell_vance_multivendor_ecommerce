                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-inner">
                                        <form action="{{route('admin.products.store')}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
...
{{--                                            </div>--}}
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <label class="form-label" for="default-06">Upload Product Vedio</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file">
