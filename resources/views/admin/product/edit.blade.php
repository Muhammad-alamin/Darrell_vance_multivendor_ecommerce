                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    ...
                                    <div class="card-inner">
                                        <form action="{{route('admin.products.update', encrypt($product->id))}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
...
{{--                                            </div>--}}
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <label class="form-label" for="default-06">Upload Product Multiple Image</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file">
