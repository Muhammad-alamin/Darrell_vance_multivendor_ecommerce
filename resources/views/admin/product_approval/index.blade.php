                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">Product approval list</h4>
                                </div>
                            </div>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="{{route('admin.add.attributes',encrypt($product->id))}}"><em class="icon ni ni-eye"></em><span>Add Attributes</span></a></li>
                                                                        <li><a href="{{route('admin.product.details',encrypt($product->id))}}"><em class="icon ni ni-eye"></em><span>View Product</span></a></li>
                                                                        <li><a href="{{route('admin.product.edit',encrypt($product->id))}}"><em class="icon ni ni-edit"></em><span>Edit Product</span></a></li>
                                                                        <li><a href="{{route('admin.products.delete', encrypt($product->id))}}"  onclick="return confirm('Are You Confirm to Delete?')"><em class="icon ni ni-trash"></em><span>Remove Product</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
