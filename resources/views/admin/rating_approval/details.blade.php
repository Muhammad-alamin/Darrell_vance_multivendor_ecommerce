                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Rating / <strong class="text-primary small">Details</strong></h3>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{route('admin.rating.approval')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                <a href="{{route('admin.rating.approval')}}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <div class="nk-block">
                                    ...
                                    <div class="card-inner">
                                        <div class="nk-block">
                                            <div class="nk-block-head">
                                                <h5 class="title">Rating Details</h5>
                                                <p></p>
                                            </div><!-- .nk-block-head -->
                                            <div class="profile-ud-list">
                                                <div class="profile-ud-item">
                                                    <div class="profile-ud wider">
                                                        ...
                                                        <span class="profile-ud-value">{{$ratings->users->name}}</span>
                                                    </div>
                                                </div>
                                                <div class="profile-ud-item">
                                                    <div class="profile-ud wider">
                                                        <span class="profile-ud-label">Customer email</span>
                                                        <span class="profile-ud-value">{{$ratings->users->email}}</span>
                                                    </div>
                                                </div>
                                                <div class="profile-ud-item">
                                                    <div class="profile-ud wider">
                                                        <span class="profile-ud-label">Customer Star Rating</span>
                                                        <span class="profile-ud-value">{{$ratings->rating}} star</span>
                                                    </div>
                                                </div>
                                                <div class="profile-ud-item">
                                                    <div class="profile-ud wider">
                                                        <span class="profile-ud-label">Product name</span>
                                                        <span class="profile-ud-value">{{$ratings->products->product_name}}</span>
                                                    </div>
                                                </div>
                                                <div class="profile-ud-item col-lg-12">
                                                    <div class="profile-ud wider">
                                                        <span class="profile-ud-label">Review Description</span>
                                                        <span class="profile-ud-value">{{$ratings->review}}</span>
                                                    </div>
                                                </div>
                                            </div><!-- .profile-ud-list -->
                                        </div><!-- .nk-block -->
                                        <div class="nk-block">
                                            <div class="profile-ud-list">
                                                <div class="profile-ud-item">
                                                    <div class="profile-ud wider">
                                                        <span class="profile-ud-label">Rating status</span>
                                                        @if($ratings->rating_status == 'Active')
                                                            <span class="profile-ud-value text-success">{{$ratings->rating_status}}</span>
                                                        @else
                                                            <span class="profile-ud-value text-danger">{{$ratings->rating_status}}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="profile-ud-item">
                                                    <div class="profile-ud wider">
                                                        <span class="profile-ud-label">Rating approval</span>
                                                        @if($ratings->rating_approval == 'Approved')
                                                            <span class="profile-ud-value text-success">{{$ratings->rating_approval}}</span>
                                                        @else
                                                            <span class="profile-ud-value text-danger">{{$ratings->rating_approval}}</span>
                                                        @endif
                                                    </div>
                                                </div>

                                                @if(isset($ratings->rating_image))
                                                <div class="profile-ud-item">
                                                    <div class="profile-ud wider">
                                                        <span class="profile-ud-label">Rating image</span>
                                                        @php($images = json_decode($ratings->rating_image))
                                                        @foreach($images as $eachimage)

                                                            <img src="{{asset('images/rating/images/'.$eachimage)}}" class="img-fluid " alt="" style="height: 40px; width: 40px; margin-right: 3px;">
