                                        ...
                                        @foreach($orders as $key=>$order)
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col tb-col-mb">
                                                    <span class="tb-lead">{{number_format( $order->grand_total,2)}}</span>
                                                </td>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="{{route('admin.sales.details',encrypt($order->id))}}"><em class="icon ni ni-edit"></em><span>Details</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
