                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-inner">
                                        <form action="{{route('admin.service-category.store')}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <label for="title" class="form-label">Service Category Name</label>
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <label class="form-label" for="default-06">Service Category Image Upload</label>
                                                        <div class="form-control-wrap">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            ...
                                                            <label  for="top_category">Top Service category</label>
