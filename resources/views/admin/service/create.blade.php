                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-inner">
                                        <form action="{{route('admin.service.store')}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_name" id="product_name" value="" placeholder="Enter Service name">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_sku" id="product_sku" value="" placeholder="Enter Service SKU">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <textarea class="form-control no-resize" name="product_description" id="product_description" placeholder="Enter Service Description"> </textarea>
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <label for="product_code" class="form-label">Service Code</label>
                                                            <input type="text" class="form-control" name="product_code" id="product_code" value="" placeholder="Enter Service Code">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_regular_price" id="product_regular_price" value="" placeholder="Enter Regular price">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_discount_price" id="product_discount_price" value="" placeholder="Enter Discount price">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_quantity" id="product_quantity" value="" placeholder="Enter quantity">
...
{{--                                            </div>--}}
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_discount_percent" id="product_discount_percent" value="" placeholder="Enter discount percent">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_discount_amount" id="product_discount_amount" value="" placeholder="Enter  discount amount">
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <label class="form-label" for="default-06">Upload Vedio</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file">
                                                                <input type="file" name="video" id="images" multiple class="custom-file-input" >
                                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                                                @error('video')<i class="text-danger">{{$message}}</i>@enderror
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
