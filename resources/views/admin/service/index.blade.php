                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        ...
                                                                        <li><a href="{{route('admin.service.details',encrypt($product->id))}}"><em class="icon ni ni-eye"></em><span>View Service</span></a></li>
                                                                        <li><a href="{{route('admin.service.edit',encrypt($product->id))}}"><em class="icon ni ni-edit"></em><span>Edit Service</span></a></li>
                                                                        <li><a href="{{route('admin.service.delete', encrypt($product->id))}}"  onclick="return confirm('Are You Confirm to Delete?')"><em class="icon ni ni-eye"></em><span>Delete Service</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
