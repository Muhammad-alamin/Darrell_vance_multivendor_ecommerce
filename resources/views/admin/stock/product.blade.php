                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">Product stock list</h4>
                                </div>
                            </div>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a href="{{route('admin.stock.edit',\Illuminate\Support\Facades\Crypt::encryptString($product->id))}}" class="disabled"><em class="icon ni ni-edit"></em><span>Stock Update</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
