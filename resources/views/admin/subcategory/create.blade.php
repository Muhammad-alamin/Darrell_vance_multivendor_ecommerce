                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-inner">
                                        <form action="{{route('sub-category.store')}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="subcat_name" id="subcat_name" value="" placeholder="Enter sub-category name">
