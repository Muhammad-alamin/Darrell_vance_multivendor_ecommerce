                                        ...
                                        @foreach($userList as $key=>$user )
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col tb-col-lg" data-order="Email Verified - Kyc Unverified">
                                                    <span>{{$user->role_as}}</span>
                                                </td>
                                                <td class="nk-tb-col tb-col-lg">
                                                    @if($user->status == 'Active')
                                                        <span class="tb-status text-success">{{$user->status}}</span>
                                                    @else
                                                        <span class="tb-status text-danger">{{$user->status}}</span>
                                                    @endif
                                                </td>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="{{route('admin.editUser',encrypt($user->id))}}"><em class="icon ni ni-edit"></em><span>Edit User</span></a></li>
                                                                        <li><a href="{{route('admin.deleteUser', encrypt($user->id))}}"  onclick="return confirm('Are You Confirm to Delete?')"><em class="icon ni ni-trash"></em><span>Remove User</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
