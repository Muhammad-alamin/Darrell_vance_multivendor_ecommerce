                                ...
                                <tr>
                                  <td style="width:100%;text-align:left;height:33px">
                                    <a href="{{ route('Home') }}" title="Last Minute Football Ticket" rel="Last Minute Football Ticket">
                                        <img src="http://127.0.0.1:8000/front/assets/images/logo1.png" alt="Last Minute Football Ticket" style="border:0" class="CToWUd" data-bit="iit">
                                    </a>
                                    </td>
                                </tr>
                              </tbody>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td>
                                                            ...
                                                            <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Thanks For Your Order. Here is Your Order ID : {{ $order->order_id }}. You Can Easily See Order Details by Dashboard.</p>
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td style="border-collapse:collapse;border-radius:3px;text-align:center;display:block;border:solid 1px #009fdf;padding:10px 16px 14px 16px;margin:0 2px 0 auto;min-width:80px;background-color:#47a2ea">
                                                                        <a href="" style="color:#1b74e4;text-decoration:none;display:block" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://instagram.com/accounts/confirm_email/S5s9GbL6/cnVhc2luZ2hlMDFAZ21haWwuY29t/?app_redirect%3DFalse&amp;source=gmail&amp;ust=1658914278556000&amp;usg=AOvVaw1eF_-1j16FhP8HtQVHGD6s">
                                                                        <center>
                          ...
                          <td style="text-align:center">
                            <div style="padding-top:10px;display:flex">
                                <div style="margin:auto">
                                    <a href="{{ route('Home') }}" title="Afribazaar Online Shop" rel="Afribazaar Online Shop">
                                        <img src="http://127.0.0.1:8000/front/assets/images/logo1.png" alt="Last Minute Football Ticket" style="border:0" class="CToWUd" data-bit="iit">
                                    </a>
                                </div>                            </div>
                            <div style="height:10px"></div>
                            <div style="color:#abadae;font-size:11px;margin:0 auto 5px auto">© Afribazaar Online Shop Inc.<br></div>
