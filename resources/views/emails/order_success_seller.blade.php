                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td>
                                                            ...
                                                            <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">You Receive an Order. Here is Your Order ID : {{ $order->order_id }}. You Can Easily See Order Details by Dashboard.</p>
                                                          </td>
                                                        </tr>
                                                        <tr>
