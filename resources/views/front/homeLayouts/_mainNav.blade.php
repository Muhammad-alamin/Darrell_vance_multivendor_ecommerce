    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                ...
                @endif
                @endif
                <a href="javascript:void(0)" class="d-lg-show">Blog</a>
                <a href="javascript:void(0)" class="d-lg-show">Contact Us</a>
                @if (Route::has('login'))
                    @auth()
