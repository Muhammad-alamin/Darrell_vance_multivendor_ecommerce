    ...
    $(document).ready(function () {
        $('#sellSize').change(function (){
            ...
            $.ajax({
                ...
                success:function (resp) {
                    // alert(response);
                    var stock =resp.split('#');
                    if( stock > 0){
                        $("#stock_check").html('<label class="product-label label-discount font-size-sm" style="background-color: green">Stock in</label>');
                    }
                    else{
