                            ...
                            <div class="products">
                                ...
                                @foreach($userCart as $eachCartItem)
                                    <div class="product product-cart">
                                        ...
                                        <button class="btn btn-link btn-close" onclick="return alert('Go to cart page & delete item')" aria-label="button">
                ...
                <div class="row cols-xl-5 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                        <div class="vendor-brand-wrap mb-8">
                            <div class="vendor-brand">
                                <a href="javascript:void(0)">
                                    <figure class="brand">
                                        <img src="{{asset('images/payment_gateway_sign/paypal.png')}}" alt="Brand" width="150"
                                             height="150" />
                                    </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/mastercard.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/stripe.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/visa.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/american_express.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/bkash.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/nogod.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/rocket.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/upay.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="javascript:void(0)">
                                <figure class="brand">
                                    <img src="{{asset('images/payment_gateway_sign/ucash.png')}}" alt="Brand" width="150"
                                         height="150" />
                                </figure>
                                <h4 class="vendor-name"></h4>
                            </a>
