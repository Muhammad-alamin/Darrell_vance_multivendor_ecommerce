                ...
                <div class="row gutter-lg">
                    <div class="main-content">
                        <form action="{{route('addToCart')}}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" value="{{$product->product_regular_price}}" name="pro_price">
                            @elseif(count($attribute_products) > 0)
                            <input type="hidden" id="price" value="{{$product->product_regular_price}}" name="pro_price">
                            @else
                            <input type="hidden" value="{{$product->product_discount_price}}" name="pro_price">
                            @endif
...
{{--                                            @endif--}}
                                        ...
                                        @if(count($attribute_products) > 0)
                                            <div class="product-form product-variation-form product-color-swatch">
                                                ...
                                                @error('pro_colour')<i class="text-danger" style="color: red; font-size: 15px;">{{$message}}</i>@enderror
                                            ...
                                            <div class="product-form product-variation-form product-size-swatch">
                                                ...
                                                @error('pro_size')<i class="text-danger">{{$message}}</i>@enderror
                                            </div>
                                        @endif
                                                ...
                                                <form action="{{route('rating.store')}}" method="post" class="review-form" enctype="multipart/form-data">
                                                    ...
                                                    <div class="rating-form">
                                                        ...
                                                        <select name="rating" id="rating" required
                                                            ...
                                                            @error('rating')<i class="text-danger" style="color: red">{{$message}}</i>@enderror
                                                        </select>
                                                    </div>
                                                    <div>
                                                    ...
                                                    @error('review')<i class="text-danger" style="color: red">{{$message}}</i>@enderror
