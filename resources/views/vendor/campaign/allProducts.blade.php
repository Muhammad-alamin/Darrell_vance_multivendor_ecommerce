                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a href="{{route('vendor.add.campaign',$product->id)}}" class="disabled"><em class="icon ni ni-edit"></em><span>Add Campaign</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            ...
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li>
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a href="{{route('vendor.add.campaign',$product->id)}}"><em class="icon ni ni-eye"></em><span>Add Campaign</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
