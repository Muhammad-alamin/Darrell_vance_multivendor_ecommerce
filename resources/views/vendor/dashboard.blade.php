                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card h-75">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-uppercase mb-1">Active Campaign</div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800" style="color: green">{{$active_campaign}}</div>
                                                <div class="mt-2 mb-0 text-muted text-xs">
                                                    <span class="text-success mr-2"><i class="fa fa-arrow-up"></i></span>
                                                    <span></span>
                                                </div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card h-75">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-uppercase mb-1">Stock Out Product</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800" style="color: red">{{$stockOut_pro}}</div>
                                                <div class="mt-2 mb-0 text-muted text-xs">
                                                    <span class="text-success mr-2"><i class="fa fa-arrow-up"></i></span>
                                                    <span></span>
                                                </div>
