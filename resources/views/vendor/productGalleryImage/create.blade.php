                            ...
                            <div class="card-aside-wrap">
                                <div class="card-content">
                                    <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                        <li class="nav-item">
                                            <a class="nav-link active"><em class="icon ni ni-product-circle"></em><span>Add Gallery-Image</span></a>
                                        </li>
                                    </ul><!-- .nav-tabs -->
                                        ...
                                        <div class="nk-block">
                                            ...
                                            <div class="profile-ud-list">
                                                <div class="profile-ud-item">
                                                    ...
                                                    <form action="{{route('add.image',$productdetails->id)}}" method="post" class="gy-3" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="profile-ud wider">
                                                            <div class="form-group mt-2">
                                                                <button type="submit" class="btn btn-lg btn-primary">Add Gallery Image</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
...
{{--                                                                            <li><a href="{{route('edit.attributes',$attribute->id)}}"><em class="icon ni ni-edit"></em><span>Edit Attributes</span></a></li>--}}
{{--                                                                            <li><a href="{{route('delete.attributes', $attribute->id)}}" onclick="return confirm('Are You Confirm to Delete?')"><em class="icon ni ni-eye"></em><span>Delete Product</span></a></li>--}}
