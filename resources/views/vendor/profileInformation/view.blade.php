                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            ...
                            <div class="nk-block-head-content">
                                <a href="{{route('vendor.dashboard')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                <a href="{{route('vendor.dashboard')}}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                            </div>
                        </div>
                            ...
                            <div class="card-aside-wrap">
                                <div class="card-content">
                                    <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('vendor.profile.image.upload')}}"><em class="icon ni ni-repeat"></em><span>Image Upload</span></a>
                                        </li>
                                    </ul><!-- .nav-tabs -->
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-10">
                                                <div class="form-group mt-2">
                                                    <a href="{{route('vendor.profile.information.edit',encrypt($profileInformation->id))}}" class="btn btn-md btn-primary">Edit Information</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- .card-inner -->
