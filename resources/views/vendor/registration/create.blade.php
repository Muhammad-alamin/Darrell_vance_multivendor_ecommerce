                ...
                <div class="nk-block nk-block-middle nk-auth-body wide-xs">
                    <div class="brand-logo pb-4 text-center">
                        <a href="html/index.html" class="logo-link">
                            <h4 class="nk-block-title">Vendor Registeration Panel</h4>
                        </a>
                    </div>
                    <div class="card">
                        <div class="card-inner card-inner-lg">
                            ...
                            <ul class="nav justify-center gx-4">
                                ...
                                <li class="nav-item"><a href="{{route('login.google')}}" class="btn btn-danger btn-block google-plus"> Login with Google <i class="fa fa-google-plus"></i> </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
