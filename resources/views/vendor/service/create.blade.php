                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-inner">
                                        <form action="{{route('vendor.service.store')}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_sku" id="product_sku" value="" placeholder="Enter  SKU">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <textarea class="form-control no-resize" name="product_description" id="product_description" placeholder="Enter  Description"> </textarea>
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_code" id="product_code" value="" placeholder="Enter  Code">
