                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    ...
                                    <div class="card-inner">
                                        <form action="{{route('vendor.service.update', encrypt($product->id))}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_name" id="product_name" value="{{old('product_name', isset($product)?$product->product_name:null)}}" placeholder="Enter Service name">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_sku" id="product_sku" value="{{old('product_sku', isset($product)?$product->product_sku:null)}}" placeholder="Enter SKU">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <textarea class="form-control no-resize" name="product_description" id="product_description"  placeholder="Enter Description"> {{old('product_description', isset($product)?$product->product_description:null)}} </textarea>
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_code" id="product_code" value="{{old('product_code', isset($product)?$product->product_code:null)}}" placeholder="Enter Code">
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <label for="product_regular_price" class="form-label"> Regular Price</label>
                                                            <input type="text" class="form-control" name="product_regular_price" id="product_regular_price" value="{{old('product_regular_price', isset($product)?$product->product_regular_price:null)}}" placeholder="Enter  Regular price">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_discount_price" id="product_discount_price" value="{{old('product_discount_price', isset($product)?$product->product_discount_price:null)}}" placeholder="Enter  Discount price">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control" name="product_quantity" id="product_quantity" value="{{old('product_quantity', isset($product)?$product->product_quantity:null)}}" placeholder="Enter quantity">
...
{{--                                            </div>--}}
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <label for="product_discount_percent" class="form-label"> Discount Percent ( Example- 10, 30, 50)</label>
                                                            <input type="text" class="form-control" name="product_discount_percent" id="product_discount_percent" value="{{old('product_discount_percent', isset($product)?$product->product_discount_percent:null)}}" placeholder="Enter  discount percent">
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <label for="product_discount_amount" class="form-label"> Discount Amount ( Example- 100, 250, 500)</label>
                                                            <input type="text" class="form-control" name="product_discount_amount" id="product_discount_amount" value="{{old('product_discount_amount', isset($product)?$product->product_discount_amount:null)}}" placeholder="Enter  discount amount">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file">
                                                                <input type="file" name="thumbnail_image" id="images" multiple class="custom-file-input" >
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <label class="form-label" for="default-06">Upload Multiple Image</label>
                                                        <div class="form-control-wrap">
                                                            <div class="custom-file">
